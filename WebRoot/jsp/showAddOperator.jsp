...
<body>
	<form action="index.do?method=doAdd" method="post" id="form" name="form">
		<table>
			<tr>
...
<script type="text/javascript" src="js/showAddOperator.js"></script>
</html>
