					...
					b.jgrid,
					{
						...
						from : function(f) {
							return new (function(j, i) {
								...
								this._repeatCommand = function(n, m) {
									if (u === null)
										return c;
									if (n != null && m != null)
										return u(n, m);
								...
								this._equals = function(n, m) {
									return c._compare(n, m, 1) === 0
								};
								this._compare = function(n, m, p) {
									if (p === undefined)
										p = 1;
									if (n === undefined)
										n = null;
								...
								this._doSort = function(n, m) {
									var p = J[m].by, A = J[m].dir, t = J[m].type, H = J[m].datefmt;
									if (m == J.length - 1)
									...
									for (A = 0; A < n.length; A++) {
										t = c._doSort(n[A].items, m);
										for (H = 0; H < t.length; H++)
											p.push(t[H])
									}
									return p
								};
								this._getOrder = function(n, m, p, A, t) {
									var H = [], S = [], Y = p == "a" ? 1 : -1, O, fa;
									if (A === undefined)
										A = "text";
									fa = A == "float" || A == "number"
											|| A == "currency"
									...
									b.each(n, function(P, ba) {
										O = b.jgrid.getAccessor(ba, m);
										if (O === undefined)
											O = "";
										O = fa(O, ba);
										S.push({
								...
								this._getGroup = function(n, m, p, A, t) {
									var H = [], S = null, Y = null, O;
									b.each(c._getOrder(n, m, p, A, t),
											function(fa, ca) {
												O = b.jgrid.getAccessor(ca, m);
												if (O === undefined)
													O = "";
												if (!c._equals(Y, O)) {
													Y = O;
								...
								this.andNot = function(n, m, p) {
									G = !G;
									return c.and(n, m, p)
								};
								this.orNot = function(n, m, p) {
									G = !G;
									return c.or(n, m, p)
								};
								this.not = function(n, m, p) {
									return c.andNot(n, m, p)
								};
								this.and = function(n, m, p) {
									Q = " && ";
									if (n === undefined)
										return c;
									return c._repeatCommand(n, m, p)
								};
								this.or = function(n, m, p) {
									Q = " || ";
									if (n === undefined)
										return c;
									return c._repeatCommand(n, m, p)
								...
								this._compareValues = function(n, m, p, A, t) {
									var H;
									H = M ? "this." + m : "this";
									if (p === undefined)
										p = null;
								...
								this.equals = function(n, m, p) {
									return c._compareValues(c.equals, n, m,
											"==", p)
								};
								this.greater = function(n, m, p) {
									return c._compareValues(c.greater, n, m,
											">", p)
								};
								this.less = function(n, m, p) {
									return c._compareValues(c.less, n, m, "<",
											p)
								};
								this.greaterOrEquals = function(n, m, p) {
									return c._compareValues(c.greaterOrEquals,
											n, m, ">=", p)
								};
								this.lessOrEquals = function(n, m, p) {
									return c._compareValues(c.lessOrEquals, n,
											m, "<=", p)
								};
								this.startsWith = function(n, m) {
									var p = m === undefined || m === null ? n
											: m;
									p = l ? b.trim(p.toString()).length : p
											.toString().length;
									if (M)
										...
										p = l ? b.trim(m.toString()).length : m
												.toString().length;
								...
								this.groupBy = function(n, m, p, A) {
									if (!c._hasData())
										return null;
									return c._getGroup(e, n, m, p, A)
								};
								this.orderBy = function(n, m, p, A) {
								...
								var J = function(d, g) {
									...
									if (b.isXMLDoc(d)) {
										if (a.p.treeANode === -1 && !a.p.scroll) {
											...
											h = h > 1 ? h : 1;
										var s, v = 0, y, E, I = 0, F = 0, K = 0, z, U = [], V, T = {}, N, L, X = [], oa = a.p.altRows === true ? " "
												+ a.p.altclass
												: "";
									...
									if (d) {
										...
										if (T = b.jgrid.getAccessor(d, g.root)) {
											V = T.length;
											d = 0;
											...
											for (; d < V;) {
												...
												for (y = 0; y < F.length; y++) {
													v = b.jgrid.getAccessor(o,
															F[y]);
													E.push(p(L, v, y + K + z
															+ U, d + h, o));
													N[a.p.colModel[y + K + z
															+ U].name] = v
												}
												E.push("</tr>");
												if (a.p.grouping) {
										...
										.click(
												function(d) {
													...
													if (W.tagName == "A"
															|| (W.tagName == "INPUT"
																	|| W.tagName == "TEXTAREA"
																	|| W.tagName == "OPTION" || W.tagName == "SELECT")
															&& !g)
														return this;
													if (h === true) {
			...
			.extend({
				...
				setSelection : function(f, j) {
					return this
							.each(function() {
								function i(l) {
									var a = b(c.grid.bDiv)[0].clientHeight, r = b(c.grid.bDiv)[0].scrollTop, u = c.rows[l].offsetTop;
				...
				setGridWidth : function(f, j) {
					return this
							.each(function() {
								if (this.grid) {
									var i = this, c, e = 0, k = i.p.cellLayout, l, a = 0, r = false, u = i.p.scrollOffset, B, G = 0, Q = 0, J = 0, M;
									if (typeof j != "boolean")
										j = i.p.shrinkToFit;
									if (!isNaN(f)) {
										f = parseInt(f, 10);
					...
					return this.each(function() {
						...
						if (e.grid) {
							if (isNaN(f))
								...
								k = parseInt(f, 10);
							if (k >= 0) {
								var l = b("tr.ui-jqgrid-labels th:eq(" + k
										+ ")", e.grid.hDiv);
								if (j) {
									var a = b(".s-ico", l);
									b("[id^=jqgh_]", l).empty().html(j).append(
											a);
									e.p.colNames[k] = j
								}
								if (i)
									typeof i === "string" ? b(l).addClass(i)
											: b(l).css(i);
				...
				setCell : function(f, j, i, c, e, k) {
					return this
							.each(function() {
								...
								if (l.grid) {
									if (isNaN(j))
										b(l.p.colModel).each(function(G) {
											if (this.name == j) {
												a = G;
												return false
											}
										...
										a = parseInt(j, 10);
									if (a >= 0)
										if (r = l.rows.namedItem(f)) {
											var B = b("td:eq(" + a + ")", r);
											if (i !== "" || k === true) {
												r = l.formatter(f, i, a, r,
														"edit");
												u = l.p.colModel[a].title ? {
													title : b.jgrid
															.stripHtml(r)
												} : {};
												l.p.treeGrid
							...
							.each(function() {
								...
								if (l.grid) {
									if (isNaN(f))
										...
										a = parseInt(f, 10);
									if (a >= 0) {
										var r = l.rows.length, u = 0;
										if (r && r > 0) {
											for (; u < r;) {
												if (b(l.rows[u]).hasClass(
														"jqgrow")) {
													try {
														e = b
																.unformat(
																		...
																		{
																			rowId : l.rows[u].id,
																			colModel : l.p.colModel[a]
																		}, a)
													} catch (B) {
														e = b.jgrid
																.htmlDecode(l.rows[u].cells[a].innerHTML)
													}
													if (i)
														k += parseFloat(e);
													else if (j)
					...
					return this.each(function() {
						...
						if (n.grid) {
							...
							for ( var q = 0; q < n.p.colModel.length; q++)
								if (n.p.colModel[q].index == f
										|| n.p.colModel[q].name == f) {
									s = q;
									break
								}
							if (s != -1) {
							...
							.each(function() {
								...
								if (this.p.filterModel.length === 0
									...
									if (n) {
											...
											a
													.each(
															...
															function(g) {
																...
																if (this.search === true
																		&& q === true) {
																	e.label = b.p.gridNames === true ? s.p.colNames[g]
																			: "";
																	e.name = this.name;
																	e.index = this.index
																			|| this.name;
													...
													.each(
															...
															function() {
																for ( var g = 0; g < n.length; g++)
																	if (this.name == n[g].name) {
																		this.index = n[g].index
																				|| this.name;
																		break
																	}
																if (!this.index)
										...
										var h = function() {
											var g = {}, e = 0, m, i = a(b.p.gridid)[0], k;
											i.p.searchdata = {};
											...
											var g = {}, e, m = 0, i = a(b.p.gridid)[0], k;
										...
										(function() {
											...
											if (b.p.enableSearch === true) {
												m = "<input type='button' id='sButton' class='"
														+ b.p.buttonclass
														+ "' value='"
														+ b.p.searchButton
														+ "'/>";
												a(k).append(m);
												a("input#sButton", k).click(
														function() {
															h();
															return false
														})
							...
							.each(function() {
								...
								var b = this, n = function() {
									...
									if (a.isFunction(f.beforeSearch))
										p = f.beforeSearch.call(b);
									p || a(b).jqGrid("setGridParam", {
										search : e
									}).trigger("reloadGrid", [ {
										page : 1
									} ]);
									k && a(b).jqGrid("setGridParam", {
										url : k
									});
									a.isFunction(f.afterSearch)
											&& f.afterSearch()
								}, s = a("<tr class='ui-search-toolbar' role='rowheader'></tr>"), q;
								a
										.each(
												b.p.colModel,
												function() {
								...
								if (i.grid && f) {
									...
									if (a("#" + k.themodal).html() != null) {
										...
										var m = "<a href='javascript:void(0)' id='"
												+ (l ? "nData" : "pData")
												+ "' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></div>", q = "<a href='javascript:void(0)' id='"
												+ (l ? "pData" : "nData")
												+ "' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></div>", A = "<a href='javascript:void(0)' id='cData' class='fm-button ui-state-default ui-corner-all'>"
												+ b.bClose + "</a>";
										if (j > 0) {
											var F = [];
											a.each(a(Q)[0].rows,
					...
					.click(
							function() {
								...
								a
										...
										.each(
												function(c) {
													var g = encodeURIComponent(jQuery(
															this)
															.find(
																	"select[name='field'] :selected")
															.val()), i = encodeURIComponent(jQuery(
															this)
															.find(
																	"select[name='op'] :selected")
															.val()), h = encodeURIComponent(jQuery(
															this)
															.find(
	...
	f.jgrid
			.extend({
				...
				groupingPrepare : function(b, c, a, d) {
					this
							.each(function() {
								var e = c[0] ? c[0].split(" ").join("") : "", g = this.p.groupingView, j = this;
					...
					return this
							.each(function() {
								...
								if (!d.groupDataSorted) {
									d.sortitems[0].sort();
									d.sortnames[0].sort();
									d.groupOrder[0].toLowerCase() == "desc"
